...
// Each hand has two subpaths: outer silhouette (M...Z) and inner detail lines (M...Z)
// We fill the outer silhouette white first, then draw both paths as black outline on top
